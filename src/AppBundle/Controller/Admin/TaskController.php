...
$posts ='';
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin/tasks/new.html.twig', array(
            'post' => $post,
    ...
    public function showAction(Post $post)
    {
        ...
        return $this->render('admin/tasks/show.html.twig', array(
            'post'        => $post,
     ...
     * from GET and POST. Since the controller that removes the tasks posts expects
